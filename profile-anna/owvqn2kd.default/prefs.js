...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1478273894);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1478274014);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1479083382);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1478274134);
...
user_pref("datareporting.sessions.current.startTime", "1479083261549");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1478273895);
...
user_pref("places.database.lastMaintenance", 1478274559);
