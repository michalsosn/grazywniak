...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1478274918);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1478275038);
...
user_pref("datareporting.sessions.current.firstPaint", 1455);
user_pref("datareporting.sessions.current.main", 20);
user_pref("datareporting.sessions.current.startTime", "1479083452555");
...
user_pref("extensions.getAddons.cache.lastUpdate", 1478274919);
